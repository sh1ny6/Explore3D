      ...
      {modal && (
        <Modal open={modal}>
          <div className='modalwindow'>
            ...
            <div
              className='modalwindow-main'
              style={{ display: 'flex', marginBottom: 20, marginTop: 10 }}
            >
              <div
        ...
        <Route
          ...
          element={
            <>
                    ...
                    <ul className='what__ul'>
                      ...
                      <li className='what__el'>
                        ...
                        <p className='what__p'>
                          ...
                          постарались убрать всё ненужное, оставив самое
                          главное.
                        </p>
                      </li>
                      <li className='what__el'>
                      ...
                      <li className='what__el'>
                        ...
                        <p className='what__p'>
                          Только проверенные источники информации помогают нам
              ...
              >
                <h2 className='h2 authors__h2'>Авторы</h2>
            ...
            <>
              ...
              >
                <model-viewer
                  id='modelspc'
                  className='modelspc'
                  style={{ width: innerWidth, height: 700, borderRadius: 38 }}
          ...
          element={
            <>
              ...
              >
                ...
                <div className='form3dcar-right'>
                  <ul className='form3dcar-right__ul'>
                    <li className='panel__el'>
                      <h3
